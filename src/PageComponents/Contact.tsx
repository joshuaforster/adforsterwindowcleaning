...
const Contact: React.FC = () => {
  ...
  return (
    <div className="relative">
      <div className="fixed inset-0 bg-white dark:bg-gray-900 -z-10"></div>
      ...
      <div
        ref={sectionRef}
        className={`pb-24 pt-16 sm:pb-32 sm:pt-24 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32 transition-all duration-1000 transform ${
